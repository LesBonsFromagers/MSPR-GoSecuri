    ...
    stages {
        ...
        stage('Compilation') 
        {
            steps 
            {
                ...
                //sh "mvn clean"
                sh "pwd"
                sh "sshpass -v -p \"root\" ssh -v -o \"StrictHostKeyChecking=no\" root@192.168.1.170 'pwd; java -version; javac -version; cd /mnt/www/html/Pipeline-MSPR/; pwd; ls; mvn clean package' "
