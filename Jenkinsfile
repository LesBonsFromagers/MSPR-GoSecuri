    ...
    stages {
        ...
        stage('Compilation') 
        {
            steps 
            {
                ...
                sh "sshpass -v -p \"root\" ssh -o \"StrictHostKeyChecking=no\" root@192.168.1.170 java /var/lib/jenkins/workspace/MSPRFolder/Pipeline-MSPR/src/main/java/com/epsi/gosecuri/Main.java"
